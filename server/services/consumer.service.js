...
import {emailNotification, getVerifyEmail, getResetPassword, getResetSuccessfulEmail,getWelcomeEmail} from "./email.service";
...
async function getResetSuccessfulEmails() {
    try {
        ...
        channel.consume(queueName, async(msg) => {
            ...
            await getResetSuccessfulEmail(payloadObject.email, payloadObject.first_name);
...
export {getNotifications, getVerifyEmails, getResetPasswords, getWelcomeEmails, getResetSuccessfulEmails};